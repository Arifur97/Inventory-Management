        ...
        <div class="row mt-1">
            <div class="col-md-12">
                <div class="float-left brand-text">
                    <h3>{{trans('file.print_barcode')}}</h3>
                </div>
            </div>
        </div>
        <br>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-6">
                                        <label>{{trans('file.add_product')}}</label><i class="fa fa-asterisk"></i>
                                    ...
                                    <div class="col-md-12">
                                        <div class="table-responsive mt-3">
                                            <table id="myTable" class="table table-hover order-list">
                                                <thead>
                                                    <tr>
                                                        <th class="not-exported" style="border-radius: 5px 0px 0px 5px">{{trans('file.name')}}</th>
                                                        <th>{{trans('file.Code')}}</th>
                                                        <th>{{trans('file.Quantity')}}</th>
                                                        <th class="not-exported" style="border-radius: 0px 5px 5px 0px"><i class="dripicons-trash"></i></th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                </tbody>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <label><strong>Paper Size</strong></label><i class="fa fa-asterisk"></i>
