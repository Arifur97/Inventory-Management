                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>{{trans('file.System Title')}}</label><i class="fa fa-asterisk"></i>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>{{trans('file.System Logo')}}</label><i class="fa fa-asterisk"></i>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>{{trans('file.System Icon')}}</label><i class="fa fa-asterisk"></i>
                                        <input type="file" name="site_icon" class="form-control" value=""/>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>{{trans('file.Currency')}}</label><i class="fa fa-asterisk"></i>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>{{trans('file.Currency Position')}}</label><br><i class="fa fa-asterisk"></i>
                                ...
                                <div class="col-md-6 d-none">
                                    <div class="form-group">
                                        <label>{{trans('file.Theme')}}</label><i class="fa fa-asterisk"></i>
                                        <div class="row ml-1">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>{{trans('file.Staff Access')}}</label><i class="fa fa-asterisk"></i>
                                        @if($lims_general_setting_data)
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>{{trans('file.Invoice Format')}}</label><i class="fa fa-asterisk"></i>
                                        @if($lims_general_setting_data)
                                ...
                                <div id="state" class="col-md-6 d-none">
                                    <div class="form-group">
                                        <label>{{trans('file.State')}}</label><i class="fa fa-asterisk"></i>
                                        @if($lims_general_setting_data)
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>{{trans('file.Date Format')}}</label><i class="fa fa-asterisk"></i>
                                        @if($lims_general_setting_data)
                                        ...
                                        <select name="date_format" class="selectpicker form-control">
                                            ...
                                            <option value="Y/m/d"> yyy/mm/dd</option>
                                            <option value="Y.m.d"> yyy.mm.dd</option>
                                            <option value="d-M-y"> dd-mmm-y</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-6 d-none">
