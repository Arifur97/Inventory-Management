          ...
          <div class="form-inner">
            ...
            <form method="POST" action="{{ route('register') }}">
              ...
              <div class="form-group-material">
                ...
                <label for="register-username" class="label-material">{{trans('file.UserName')}}</label><i class="fa fa-asterisk"></i>
                @if ($errors->has('name'))
                    <p>
              ...
              <div class="form-group-material">
                ...
                <label for="register-email" class="label-material">{{trans('file.Email')}}</label><i class="fa fa-asterisk"></i>
                @if ($errors->has('email'))
                    <p>
              ...
              <div class="form-group-material">
                ...
                <label for="register-phone" class="label-material">{{trans('file.Phone Number')}}</label><i class="fa fa-asterisk"></i>
              </div>
              <div class="form-group-material">
              ...
              <div id="customer-section">
                  ...
                  <div class="form-group-material">
                    ...
                    <label for="customer-address" class="label-material">{{trans('file.Address')}}</label><i class="fa fa-asterisk"></i>
                  </div>
                  <div class="form-group-material">
                    <input id="customer-city" type="text" name="city" class="input-material customer-field">
                    <label for="customer-city" class="label-material">{{trans('file.City')}}</label><i class="fa fa-asterisk"></i>
                  </div>
                  <div class="form-group-material">
              ...
              <div class="form-group-material" id="biller-id">
                <select name="biller_id" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Select Biller..."><i class="fa fa-asterisk"></i>
              ...
              <div class="form-group-material" id="warehouse-id">
                <select name="warehouse_id" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Select Warehouse..."><i class="fa fa-asterisk"></i>
              ...
              <div class="form-group-material">
                ...
                <label for="passowrd" class="label-material">{{trans('file.Password')}}</label><i class="fa fa-asterisk"></i>
              ...
              <div class="form-group-material">
                ...
                <label for="password-confirm" class="label-material">{{trans('file.Confirm Password')}}</label><i class="fa fa-asterisk"></i>
              </div>
