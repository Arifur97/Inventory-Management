...
class CategoryController extends Controller
{
    ...
    public function categoryData(Request $request)
    {
        ...
        if(!empty($categories))
        {
            foreach ($categories as $key=>$category)
            {
                ...
                if($category->image)
                    $nestedData['image'] = '<img src="'.url('/images/category', $category->image).'" height="70" width="70" class="product_image">';
                else
                ...
                if($category->is_active == 1)
                    $nestedData['is_active'] = '<div class="badge badge-success">Yes</div>';
                else
                    $nestedData['is_active'] = '<div class="badge badge-danger">No</div>';
    ...
    public function edit($id)
    {
        ...
        // return view('category.create',compact('lims_category_data', 'lims_category_data'));
    }
