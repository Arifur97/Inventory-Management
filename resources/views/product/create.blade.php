...
<section class="forms">
    ...
    {!! Form::open(['route' => 'products.store', 'method' => 'post', 'files' => true, 'class' => 'product-form' , 'id' => 'product-form']) !!}
    <div class="row item-sticky">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body item-page">
                    <div class="float-left brand-text mt-2 pl-4">
                        <h3>{{trans('file.add_product')}}</h3>
                    </div>
                    <div class="float-right mr-2">
                        <div class="form-group">
                            <a href="{{route('products.index')}}" class="btn buttons-add"><i class="fa fa-times mr-1"></i> {{trans('file.Cancel')}}</a>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>{{trans('file.Product Type')}}</strong></label><i class="fa fa-asterisk"></i><i class="dripicons-question" data-toggle="tooltip" title="{{trans('file.Select the Product Type as Stockable (stock will be maintained), Combo (Combination of products), Non-stockable (Do not want to track the stock), Temporary (Not an invenotry item. Used in Quotation and price comaprison)')}}"></i>
                                    <div class="input-group">
                                        <select name="type" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Select Product Type...">
                                        @foreach($lims_producttype_list as $producttype)
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>{{trans('file.Is Merchandise')}}</strong></label><i class="fa fa-asterisk"></i><i class="dripicons-question" data-toggle="tooltip" title="{{trans('file.Is the product a merchandise (will be displayed in POS and sale) or non-merchandise')}}"></i>
                                    <div class="input-group">
                                        <select name="is_merchandise" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Select Is Merchandise...">
                                            @foreach($lims_yesno_list as $is_merchandise)
                                                <option value="{{$is_merchandise->id}}">{{$is_merchandise->yes_no}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>{{trans('file.Is Active')}}</strong></label><i class="fa fa-asterisk"></i>
                                    <div class="input-group">
                                        <select name="is_active" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Select Is Active...">
                                            @foreach($lims_yesno_list as $is_active)
                                                <option value="{{$is_active->id}}">{{$is_active->yes_no}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>{{trans('file.category')}}</strong></label><i class="fa fa-asterisk"></i>
                                    <div class="input-group">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>{{trans('file.Product Name')}}</strong></label><i class="fa fa-asterisk"></i>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>{{trans('file.Product Code')}}</strong></label><i class="fa fa-asterisk"></i>
                                    <div class="input-group">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label>{{trans('file.Barcode Symbology')}}</strong></label><i class="fa fa-asterisk"></i>
                                    <div class="input-group">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                <label>{{trans('file.Other Code')}}</label>
                                <input type="text" name="other_code" class="form-control" >
                            </div>
                        </div>
                        <div id="digital" class="col-md-4">
                            <div class="form-group">
                                <label>{{trans('file.Attach File')}}</strong></label><i class="fa fa-asterisk"></i>
                                <div class="input-group">
                        ...
                        <div id="unit" class="col-md-12">
                            <div class="row ">
                                <div class="col-md-4 form-group">
                                        <label>{{trans('file.Product Unit')}}</strong></label><i class="fa fa-asterisk"></i>
                                        <div class="input-group">
                        ...
                        <div id="cost" class="col-md-4">
                            <div class="form-group">
                                <label>{{trans('file.Product Cost')}}</strong></label><i class="fa fa-asterisk"></i>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>{{trans('file.Product Price')}}</strong></label><i class="fa fa-asterisk"></i>
                        ...
                        <div class="col-md-2">
                            <div class="form-group mt-3">
                                <input type="checkbox" name="workorder" value="1">&nbsp;
                                <label>{{trans('file.Work Order')}}</label>
                                <p class="italic">{{trans('file.Product will be displayed in Workorder Bulk Add')}}</p>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
