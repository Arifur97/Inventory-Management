                        ...
                        <div class="card-body item-page">
                            ...
                            <div class="float-right mr-2">
                                <div class="form-group">
                                    ...
                                    <a href="{{url('purchases/purchase_by_csv')}}" class="btn btn-primary"><i class="dripicons-copy mr-1"></i> {{trans('file.import')}}</a>

                                    <a href="{{route('purchases.create')}}" class="btn buttons-add"><i class="fa fa-plus mr-1"></i> {{trans('file.add')}}</a>
                                    @endif
                            </div>
                        </div>
                    </div>
            ...
            <div class="row mb-6">
                <div class="col-md-4 offset-md-2 mt-3">
                    <div class="form-group row">
                        <label class="d-tc mt-2">{{trans('file.Choose Your Date')}} &nbsp;</label>
                        <div class="d-tc">
                ...
                <div class="col-md-4 mt-3 @if(\Auth::user()->role_id > 2){{'d-none'}}@endif">
                    <div class="form-group row">
                        <label class="d-tc mt-2">{{trans('file.Choose Warehouse')}} &nbsp;</label>
                        <div class="d-tc">
      ...
      <div class="modal-content">
        <div class="modal-header item-page">
          ...
          <div class="col-md-12">
            ...
            <div class="float-right mr-2">
                <div class="form-group">
                    <a href="{{ route('purchases.index') }}" class="btn btn-secondary" onclick="AddProducts()"><i class="fa fa-power-off mr-1"></i> {{trans('file.Reset')}}</a>
                </div>
            </div>
            ...
            <div class="row mt-5 mb-3">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            {{-- <select id="warehouse_id" name="warehouse_id" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Select warehouse..."  multiple >
                                @foreach($lims_warehouse_list as $warehouse)
                                <option value="{{$warehouse->id}}">{{$warehouse->name}}</option>
                                @endforeach
                            </select> --}}
                ...
                <div class="col-md-4 mt-3">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            {{-- <select id="supplier_id" name="supplier_id" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Select Supplier..."  multiple >
                ...
                <div class="col-md-4 mt-3">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <select id="payment_status_id" name="payment_status_id" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Select Payment Status..."  >
                                @foreach($lims_payment_status_list as $status)
                                <option value="{{$status->id}}"
                                    @if($status->id == ($payment_status_id??'')) selected @endif>{{$status->name}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                ...
                <div class="col-md-4 mt-3">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <select id="purchase_status_id" name="purchase_status_id" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Select Status..."  >
                                @foreach($lims_status_list as $status)
                                <option value="{{$status->id}}"
                                    @if($status->id == ($purchase_status_id??'')) selected @endif>{{$status->name}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    function dataTable() {
        ...
        var purchase_status_id = $("#purchase_status_id").val();
