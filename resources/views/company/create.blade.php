                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>{{trans('file.Country')}}</label><i class="fa fa-asterisk"></i>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select required name="currency_position" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Select Currency Position...">
