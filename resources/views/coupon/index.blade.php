                ...
                <div class="card-body item-page">
                    ...
                    <div class="float-right mr-2">
                        <div class="form-group">
                            ...
                            <button class="btn buttons-add" data-toggle="modal" data-target="#create-modal"><i class="fa fa-plus mr-1" aria-hidden="true"></i> {{trans('file.add')}}</button>                         
                    </div>
                </div>
            </div>
        </div>
                ...
                {!! Form::open(['route' => 'coupons.store', 'method' => 'post']) !!}
                  <div class="row">
                      <div class="col-md-6 form-group">
                          <label>{{trans('file.Coupon Code')}}</label><i class="fa fa-asterisk"></i>
                      ...
                      <div class="col-md-6 form-group">
                          <label>{{trans('file.Type')}}</label><i class="fa fa-asterisk"></i>
                      ...
                      <div class="col-md-6 form-group minimum-amount">
                          <label>{{trans('file.Minimum Amount')}}</label><i class="fa fa-asterisk"></i>
                      ...
                      <div class="col-md-6 form-group">
                          ...
                          <div class="input-group">
                              ...
                              <div class="input-group-append mt-1">
                                  <span class="icon-text" style="font-size: 18px;"><strong>%</strong></span>
                              </div>
                          </div>
                      </div>
                      <div class="col-md-6 form-group">
                          <label>Qty</label><i class="fa fa-asterisk"></i>
      ...
      <div class="modal-content">
          ...
          <div class="modal-body">
            <p class="italic"><small>{{trans('file.The field labels marked with * are required input fields')}}.</small></p>
              ...
              <div class="row">
                <div class="col-md-6 form-group">
                    <label>{{trans('file.Coupon')}} {{trans('file.Code')}}</label><i class="fa fa-asterisk"></i>
                    <div class="input-group">
