...
<section class="forms">
    ...
    {!! Form::open(['route' => 'holding.store', 'method' => 'post', 'files' => true]) !!}
    <!--- header section  --->
    <div class="row ">
            ...
            <div class="card ">
                <div class="card-body item-page">
                    <div class="float-left brand-text mt-2 pl-4">
                        <h3>{{trans('file.Add Holding')}}</h3>
                    </div>
                    <div class="float-right mr-2">
                        <div class="form-group">
                            <a href="{{route('holding.index')}}" class="btn buttons-add"><i class="fa fa-times mr-1"></i> {{trans('file.Cancel')}}</a>
                            <button type="submit" id="submit-btn" class="save btn btn-primary"><i class="fa fa-check mr-1"></i>{{trans('file.submit')}}</button>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>{{trans('file.Holding Logo')}}</label>
                                            <input type="file" name="holding_logo" class="form-control" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>{{trans('file.Currency')}} <i class="fa fa-asterisk"></i></label>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>{{trans('file.Currency Position')}} <i class="fa fa-asterisk"></i></label> <br>
                                            <select required name="currency_position" class="selectpicker form-control">
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>{{trans('file.Staff Access')}}<i class="fa fa-asterisk"></i></label>
                                            <select required name="staff_access" class="selectpicker form-control">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select required name="is_active" class="selectpicker form-control" >
                                ...
                                <div class="form-group">
                                    <input type="submit" value="{{trans('file.submit')}}" class="save btn btn-primary" id="submit-button">
                                </div>
...
<script type="text/javascript">
    ...
    function AddCompanyToTable(data) {
        ...
        for (let company in data['companies']) {
            ...
            if (hasDataOnTable(data['companies'][company]['id'])) {
                ...
                cols +=
                    '<td><button type="button" onclick="removeCompanyTableItem(this);" class="ibtnDel btn btn-md btn-danger"><i class="dripicons-trash"></i></button></td>';
    ...
    function removeCompanyTableItem(qty) {
