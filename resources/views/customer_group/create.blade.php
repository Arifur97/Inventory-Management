                ...
                <div class="card-body item-page">
                    ...
                    <div class="float-right mr-2">
                        <div class="form-group">                           
                            ...
                            <a href="#" data-toggle="modal" data-target="#importcustomer_group" class="btn btn-primary"><i class="dripicons-copy"></i> {{trans('file.import')}}</a>
  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
      ...
      <form>
        ...
        <div class="form-group">
          <label>{{trans('file.Percentage')}}(%) </label><i class="fa fa-asterisk"></i>
