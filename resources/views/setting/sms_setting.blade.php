                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <label>{{trans('file.Gateway')}}</label><i class="fa fa-asterisk"></i>
                                    ...
                                    <div class="form-group clickatell">
                                        <label>API Key</label><i class="fa fa-asterisk"></i>
