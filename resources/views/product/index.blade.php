...
<section>
                ...
                <div class="card-body item-page">
                    ...
                    <div class="float-right mr-2">
                        <div class="form-group">
                            ...
                            <a href="{{route('products.create')}}" class="btn buttons-add"><i class="fa fa-plus mr-1"></i> {{trans('file.add')}}</a>
                            @endif
    ...
    <div class="table-responsive">
        <table id="product-data-table" class="table table-hover" style="width: 100%">
            <thead>
                <tr>
                    ...
                    <th>{{trans('file.Other Code')}}</th>
                    <th>{{trans('file.Quantity')}}</th>
                    <th>{{trans('file.Unit')}}</th>
                    <th>{{trans('file.Price')}}</th>
                    <th>{{trans('file.Type')}}</th>
                    <th>{{trans('file.Merchandise')}}</th>
                    ...
                    <div class="row mt-5 mb-3">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <select id="brand_id" name="brand_id" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" >
                                        <option value="0">{{trans('file.All Brand')}}</option>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <select id="unit_id" name="unit_id" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" >
                                        <option value="0">{{trans('file.All Unit')}}</option>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>{{trans('file.Type')}}</strong> </label>
                                <div class="input-group">
                                    <select id="type_id" name="type_id" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" >
                                        <option value="0">{{trans('file.All Type')}}</option>
                                        @foreach($lims_type_list as $type)
                                            @if($type->id == $type_id)
                                                <option selected value="{{$type->id}}">{{$type->unit_name}}</option>
                                            @else
        ...
        if(product[17]) {
            ...
            if(product_image.length > 1) {
                ...
                for (var i = 0; i < product_image.length; i++) {
                    if(!i)
                        slidertext += '<div class="carousel-item active"><img src="/images/product/'+product_image[i]+'" class="product_image" height="300" width="100%"></div>';
                    else
                        slidertext += '<div class="carousel-item"><img src="/images/product/'+product_image[i]+'" class="product_image" height="300" width="100%"></div>';
                }
                ...
                slidertext = '<img src="/images/product/'+product[17]+'" class="product_image" height="300" width="100%">';
            }
        }
