                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>{{trans('file.Default Customer')}}</label><i class="fa fa-asterisk"></i>
                                    ...
                                    <div class="form-group">
                                        <label>{{trans('file.Default Biller')}}</label><i class="fa fa-asterisk"></i>
                                        @if($lims_pos_setting_data)
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>{{trans('file.Default Warehouse')}}</label><i class="fa fa-asterisk"></i>
                                        @if($lims_pos_setting_data)
                                    ...
                                    <div class="form-group">
                                        <label>{{trans('file.Displayed Number of Product Row')}}</label><i class="fa fa-asterisk"></i>
                                    ...
                                    <div class="form-group">
                                        <label>Stripe Secret key </label><i class="fa fa-asterisk"></i>
