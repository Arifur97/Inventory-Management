                ...
                <div class="card-body item-page">
                    ...
                    <div class="float-right mr-2">
                        <div class="form-group">
                            ...
                            <a href="#" data-toggle="modal" data-target="#importSupplier" class="btn btn-primary"><i class="dripicons-copy mr-1"></i> {{trans('file.import')}}</a>

                            <a href="{{route('supplier.create')}}" class="btn buttons-add"><i class="fa fa-plus mr-1"></i> {{trans('file.add')}}</a>
                            @endif
                        </div>
                    </div>
                </div>
        ...
        <table id="supplier-table" class="table">
            ...
            <tbody>
                ...
                <tr data-id="{{$supplier->id}}">
                    <td>{{$key}}</td>
                    @if($supplier->image)
                    <td> <img src="{{url('/images/supplier',$supplier->image)}}" class="product_image" alt="product image" width="80" height="80"/>
                    </td>
                    @else
                    <td>No Image</td>
                    @endif
