                ...
                <div class="card-body item-page">
                    ...
                    <div class="float-right mr-2">
                        <div class="form-group">
                            ...
                            <a href="#" data-toggle="modal" data-target="#importBrand" class="btn btn-primary"><i class="dripicons-copy mr-1"></i> {{trans('file.import')}}</a>
        ...
        <table id="biller-table" class="table">
            ...
            <tbody>
                ...
                <tr data-id="{{$brand->id}}">
                    <td>{{$key}}</td>
                    @if($brand->image)
                    <td> <img src="{{url('/images/brand',$brand->image)}}" class="product_image" alt="product image" width="80" height="80">
                    </td>
                    @else
                    <td>No Image</td>
                    @endif
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p class="italic"><small>{{trans('file.The field labels marked with * are required input fields')}}.</small></p>
            <div class="form-group">
                <label>{{trans('file.Title')}}</label><i class="fa fa-asterisk"></i>
