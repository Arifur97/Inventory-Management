...
<section class="forms">
    ...
    {!! Form::open(['route' => ['company.update', $lims_company_all->id ], 'method' => 'put', 'files' => true]) !!}
    <!--- header section  --->
            ...
            <div class="card">
                <div class="card-body item-page">
                    <div class="float-left brand-text mt-2 pl-4">
                        <h3>{{trans('file.Update Company')}}</h3>
                    </div>
                    <div class="float-right mr-2">
                        <div class="form-group">
                            <a href="{{route('company.index')}}" class="btn buttons-add"><i class="fa fa-times mr-1"></i> {{trans('file.Cancel')}}</a>
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" class="form-control" value="{{$lims_company_all->name}}" />
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>{{trans('file.Code')}}</label>
                                            <input type="text" name="code" class="form-control" value="{{$lims_company_all->code}}" />
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label>{{trans('file.Favicon')}}</label>
                                            <input type="file" name="favicon" class="form-control" value="{{$lims_company_all->favicon}}" />
                                        </div>
                                    </div>
                                    <div class="col-md-1">
                                        <div class="form-group">
                                            <label>{{trans('file.Favicon')}}</label>
                                            @if($lims_company_all->favicon)
                                                <img src="{{ url('/companies/favicon', $lims_company_all->favicon) }}" class="w-75" alt="Company Favicon">
                                            @else
                                                <img src="{{url('/companies/images/no-company.png')}}" class="w-75" alt="Company Favicon">
                                            @endif
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="file" name="company_logo" class="form-control" value="{{$lims_company_all->company_logo}}" />
                                        </div>
                                    </div>
                                    <div class="col-md-1">
                                        <div class="form-group">
                                            <label>{{trans('file.Company Logo')}}</label>
                                            @if($lims_company_all->company_logo)
                                                <img src="{{ url('/companies/images', $lims_company_all->company_logo) }}" class="w-75" alt="Company Logo">
                                            @else
                                                <img src="{{url('/companies/images/no-company.png')}}" class="w-75" alt="Company Logo">
                                            @endif
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="email" name="email" class="form-control" value="{{$lims_company_all->email}}" />
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>{{trans('file.Phone Number')}}</label>
                                            <input type="number" name="phone_number" class="form-control" value="{{$lims_company_all->phone_number}}" />
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>{{trans('file.Vat Number')}}</label>
                                            <input type="text" name="vat_number" class="form-control" value="{{$lims_company_all->vat_number}}" />
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>{{trans('file.Country')}}</label>
                                            <input type="hidden" name="country_hidden" value="{{$lims_company_all->country}}" />
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="address" class="form-control" value="{{$lims_company_all->address}}" />
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>{{trans('file.City')}}</label>
                                            <input type="text" name="city" class="form-control" value="{{$lims_company_all->city}}" />
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>{{trans('file.State')}}</label>
                                            <input type="text" name="state" class="form-control" value="{{$lims_company_all->state}}" />
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>{{trans('file.Postal Code')}}</label>
                                            <input type="text" name="postal_code" class="form-control" value="{{$lims_company_all->postal_code}}" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="currency_id_hidden" value="{{$lims_company_all->currency_id}}" />
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="currency_position_hidden" value="{{$lims_company_all->currency_position}}" />
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="date_format_hidden" value="{{$lims_company_all->date_format}}" />
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="invoice_format_hidden" value="{{$lims_company_all->invoice_format}}" />
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="staff_access_hidden" value="{{$lims_company_all->staff_access}}" />
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="theme_hidden" value="{{$lims_company_all->theme}}" />
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="is_active_hidden" value="{{$lims_company_all->is_active}}" />
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea rows="5" class="form-control" name="description">{{$lims_company_all->description}}</textarea>
                                        </div>
                                    </div>
                                </div>
