...
<section class="forms pos-section">
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body-pos" style="padding-bottom: 0; background: #1e2434; border-radius: 20px 20px 0px 0px;">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <div class="table-responsive transaction-list" style="height: 450px;">
                                        <table id="myTable" class="table table-hover table-striped order-list table-fixed" style="background: #1e2434">
                                            <thead class="text-white">
                                                <tr>
                                                    <th class="col-sm-2">{{trans('file.product')}}</th>
                                                    <th class="col-sm-2">{{trans('file.Batch No')}}</th>
                                                    <th class="col-sm-2 text-right">{{trans('file.Price')}}</th>
                                                    <th class="col-sm-3 text-left">{{trans('file.Quantity')}}</th>
                                                    <th class="col-sm-2 text-right">{{trans('file.Subtotal')}}
                                                    </th>
                                                </tr>
                                            </thead>
                                            <tbody id="tbody-id">
                                ...
                                <div class="row" style="height: 600px; display: none;">
                                    <div class="col-md-2">
                                        <div class="form-group">
                    ...
                    <div class="payment-options">
                        <div class="column-5">
                            <button type="button" class="btn btn-custom payment-btn buttons-print-2" data-toggle="modal" data-target="#add-payment" id="cash-btn"><i class="fa fa-money"></i> Cash</button>
                        </div>
                        <div class="column-5">
                            <button type="button" class="btn btn-custom payment-btn buttons-print-2" data-toggle="modal" data-target="#add-payment" id="credit-card-btn"><i class="fa fa-credit-card"></i> Card</button>
                        </div>
                        <div class="column-5">
                            <button type="button" class="btn btn-custom payment-btn buttons-print-2" data-toggle="modal" data-target="#add-payment" id="cheque-btn"><i class="fa fa-money"></i> Cheque</button>
                        </div>
                        <div class="column-5">
                            <button type="button" class="btn btn-custom payment-btn buttons-print-2" data-toggle="modal" data-target="#add-payment" id="paypal-btn"><i class="fa fa-paypal"></i> Paypal</button>
                        </div>
                        <div class="column-5">
                            <button type="button" class="btn btn-custom payment-btn buttons-print-2" data-toggle="modal" data-target="#add-payment" id="gift-card-btn"><i class="fa fa-credit-card-alt"></i> GiftCard</button>
                        </div>
                        <div class="column-5">
                            <button type="button" class="btn btn-custom payment-btn buttons-print-2" data-toggle="modal" data-target="#add-payment" id="deposit-btn"><i class="fa fa-university"></i> Deposit</button>
                        </div>
                        @if($lims_reward_point_setting_data->is_active)
                        <div class="column-5">
                            <button type="button" class="btn btn-custom payment-btn buttons-print-2" data-toggle="modal" data-target="#add-payment" id="point-btn"><i class="dripicons-rocket"></i> Points</button>
                        </div>
                        @endif
                        <div class="column-5">
                            <button type="button" class="btn btn-custom buttons-print-2" id="draft-btn"><i class="fa fa-floppy-o"></i> Draft</button>
                        </div>
                        <div class="column-5">
                        ...
                        <div class="column-5">
                            <button type="button" class="btn btn-custom buttons-print-2" data-toggle="modal" data-target="#recentTransaction"><i class="dripicons-clock"></i> Recent transaction</button>
                        </div>
                    </div>
                </div>
            </div>
                      ...
                      <div class="container-fluid">
                        <div class="navbar-holder d-flex align-items-center justify-content-between">
                            ...
                            <div class="col-md-4">
                                <div class="">
                                       <a href="{{url('/')}}">
                                       <img class="mr-2 pos-logo" src="{{asset('/images/LogoHeader.png') }}">
                                       </a>
                                </div>
                            </div>
                          ...
                          <div class="navbar-header">
                            ...
                            ?>
                            @if($pos_setting_permission_active)
                            <li class="nav-item"><a class="dropdown-item dropdown-item2" data-toggle="tooltip" href="{{route('setting.pos')}}" title="{{trans('file.POS Setting')}}"><i class="dripicons-gear"></i></a> </li>
                            @endif
          ...
          <div class="row">
                    <div class="col-md-4">
                        <button class="btn btn-block buttons-print-2" id="category-filter">{{trans('file.category')}}</button>
                    </div>
                    <div class="col-md-4">
                        <button class="btn btn-block buttons-print-2" id="brand-filter">{{trans('file.Brand')}}</button>
                    </div>
                    <div class="col-md-4">
                        <button class="btn btn-block buttons-print-2" id="featured-filter">{{trans('file.Featured')}}</button>
                    </div>
                    <div class="col-md-12 mt-1 table-container table-responsive image-group">
                        <table id="product-table" class="table no-shadow product-list">
                            ...
                            @for ($i=0; $i < ceil($product_number/5); $i++)
                                <tr>
                                    <td class="product-img sound-btn" title="{{$lims_product_list[0+$i*5]->name}}" data-product ="{{$lims_product_list[0+$i*5]->code . ' (' . $lims_product_list[0+$i*5]->name . ')'}}"><img  src="{{url('/images/product',$lims_product_list[0+$i*5]->base_image)}}" class="product_image zoom-out black-white" alt="product image" width="100%" />
                                        <p>{{$lims_product_list[0+$i*5]->name}}</p>
                                        <span>{{$lims_product_list[0+$i*5]->code}}</span>
                                    </td>
                                    @if(!empty($lims_product_list[1+$i*5]))
                                    <td class="product-img sound-btn" title="{{$lims_product_list[1+$i*5]->name}}" data-product ="{{$lims_product_list[1+$i*5]->code . ' (' . $lims_product_list[1+$i*5]->name . ')'}}"><img  src="{{url('/images/product',$lims_product_list[1+$i*5]->base_image)}}" class="product_image zoom-out black-white" alt="product image" width="100%" />
                                    ...
                                    <td class="product-img sound-btn" title="{{$lims_product_list[2+$i*5]->name}}" data-product ="{{$lims_product_list[2+$i*5]->code . ' (' . $lims_product_list[2+$i*5]->name . ')'}}"><img  src="{{url('/images/product',$lims_product_list[2+$i*5]->base_image)}}" class="product_image zoom-out black-white" alt="product image" width="100%" />
                                    ...
                                    <td class="product-img sound-btn" title="{{$lims_product_list[3+$i*5]->name}}" data-product ="{{$lims_product_list[3+$i*5]->code . ' (' . $lims_product_list[3+$i*5]->name . ')'}}"><img  src="{{url('/images/product',$lims_product_list[3+$i*5]->base_image)}}" class="product_image zoom-out black-white" alt="product image" width="100%" />
                                    ...
                                    <td class="product-img sound-btn" title="{{$lims_product_list[4+$i*5]->name}}" data-product ="{{$lims_product_list[4+$i*5]->code . ' (' . $lims_product_list[4+$i*5]->name . ')'}}"><img  src="{{url('/images/product',$lims_product_list[4+$i*5]->base_image)}}" class="product_image zoom-out black-white" alt="product image" width="100%" />
                      ...
                      <p class="italic"><small>{{trans('file.The field labels marked with * are required input fields')}}.</small></p>
                        <div class="row">
                          <div class="col-md-6 form-group warehouse-section">
                              <label>{{trans('file.Warehouse')}}</strong></label><i class="fa fa-asterisk"></i>
                          ...
                          <div class="col-md-6 form-group">
                              <label>{{trans('file.Cash in Hand')}}</strong></label><i class="fa fa-asterisk"></i>
...
<script type="text/javascript">
  ...
  function addNewProduct(data){
      ...
      cols += '<td class="col-sm-2 product-title"><button type="button" class="edit-product btn btn-link btn-link-pos" data-toggle="modal" data-target="#editModal"><strong>' + data[0] + '</strong></button><br>' + data[1] + '<p>In Stock: <span class="in-stock"></span></p></td>';
      if(data[12]) {
      ...
      cols += '<td class="col-sm-2 product-price text-right"></td>';
      ...
      cols += '<td class="col-sm-2 sub-total font-weight-bold text-right"></td>';
      cols += '<td class="col-sm-1"><button type="button" class="edit-product btn btn-edit" data-toggle="modal" data-target="#editModal"><i class="dripicons-document-edit"></i></button> <button type="button" class="ibtnDel btn btn-danger btn-sm"><i class="dripicons-trash"></i></button></td>';
