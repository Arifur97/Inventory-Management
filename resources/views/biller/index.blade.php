                ...
                <div class="card-body item-page">
                    ...
                    <div class="float-right mr-2">
                        <div class="form-group">
                            ...
                            <a href="{{route('biller.create')}}" class="btn buttons-add"><i class="fa fa-plus mr-1"></i> {{trans('file.add')}}</a>
                            @endif
                        </div>
                    </div>
                </div>
        ...
        <table id="biller-table" class="table">
            ...
            <tbody>
                ...
                <tr data-id="{{$biller->id}}">
                    <td>{{$key}}</td>
                    @if($biller->image)
                    <td> <img src="{{url('/images/biller',$biller->image)}}" class="product_image" alt="product image" width="80" height="80">
                    </td>
                    @else
                    <td>No Image</td>
                    @endif
