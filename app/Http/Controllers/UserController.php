...
class UserController extends Controller
{
    ...
    public function index()
    {
        ...
        if($role->hasPermissionTo('users-index')){
            ...
            $lims_user_list = User::where('is_deleted', false)->orderBy('id', 'desc')->get();
    ...
    public function create()
    {
        ...
        if($role->hasPermissionTo('users-add')){
            ...
            return view('user.create', compact('lims_role_list', 'lims_biller_list', 'lims_warehouse_list', 'lims_customer_group_list', 'companies'));
        }
        else
            return redirect()->back()->with('not_permitted', 'Sorry! You are not allowed to access this module');
    }
    ...
    public function store(Request $request)
    {
        ...
        $data['company_id'] = json_encode($data['company_id']);
        $data['warehouse_id'] = json_encode($data['warehouse_id']);
    ...
    public function update(Request $request, $id)
    {
        ...
        $input['company_id'] = json_encode($input['company_id']);
        $input['warehouse_id'] = json_encode($input['warehouse_id']);
