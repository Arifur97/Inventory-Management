                ...
                <div class="card ">
                    <div class="card-body item-page">
                        <div class="float-left brand-text mt-2 pl-4">
                            @if($lims_item_requirment_data->reference_no == null )
                            <h3>{{trans('file.Add Item Requirement')}}</h3>
                            @else
                                <h3>{{trans('file.Update Item Requirement')}}</h3>
                            @endif
                        </div>
                        ...
                        <div class="float-right mr-2">
                            <div class="form-group">
                                <button type="button" onclick="saveItemRequirement();" class="btn btn-save" id="submit-btn-save" data-toggle="tooltip" title="{{trans('file.Use ctrl+s to save')}}"><i class="fa fa-floppy-o mr-2" aria-hidden="true"></i> {{trans('file.Save')}}</button>
                            </div>
                        </div>
                        <div class="float-right mr-2">
                            <div class="form-group">
                                <input type="hidden" id="itemRequirementIsConfirm" name="itemRequirementIsConfirm" value="">
                                <button type="button" onclick="confirmItemRequirement();" class="btn btn-primary" id="submit-btn-confirm"><i class="fa fa-check-square-o mr-2" aria-hidden="true"></i> {{trans('file.Confirm')}}</button>
                            </div>
                        </div>
                        <div class="float-right mr-2">
                            <div class="form-group">
                                            ...
                                            <div class="table-responsive mt-3">
                                                <table id="myTable" class="table table-hover order-list">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                            <td><img src="{{asset("/images/product/$product_data->image") }}" alt="product image" class="product_image" width="80" height="80"/></td>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header d-flex align-items-center">
                            <h3 class="brand-text pl-2">{{trans('file.Workflow History')}}</h3>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                        ...
                                        <div class="col-md-12">
                                            <div class="table-responsive mt-3">
                                                <table id="myTable" class="table table-hover order-list">
                                                    <thead>
                                                        <tr>
                                                            <th style="border-radius: 5px 0px 0px 5px">{{trans('file.Stage')}}</th>
                                                            <th>{{trans('file.Status')}}</th>
                                                            <th>{{trans('file.Approval')}}</th>
                                                            <th>{{trans('file.Date Assigned')}}</th>
                                                            <th>{{trans('file.Date Action')}}</th>
                                                            <th>{{trans('file.User')}}</th>
                                                            <th>{{trans('file.Designation')}}</th>
                                                            <th>{{trans('file.Warehouse')}}</th>
                                                            <th>{{trans('file.Priority')}}</th>
                                                            <th>{{trans('file.Note')}}</th>
                                                            <th>{{trans('file.Sent To Designation')}}</th>
                                                            <th>{{trans('file.Sent To Location')}}</th>
                                                        </tr>
                                                    </thead>
        ...
        {{-- ---------------- 3rd card -------------------- --}}
            ...
            <div class="row mt-4">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header d-flex align-items-center">
                            <h3 class="brand-text pl-2">{{trans('file.Workflow Action')}}</h3>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                    ...
                                    <input type="file" multiple id="multiFileEdit" name="document[]" class="form-control mb-4" onchange="selectMultipleFile(this);">
...
$('button[name="update_btn"]').on("click", function() {
 ...
 $('#bulkproduct-table tbody').on('click', 'tr', function(e) {
    ...
    function AddProducts() {
        ...
        $.ajax ({
            url: '/s2/item_requirement/getSelectedProducts',
