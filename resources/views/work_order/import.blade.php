        ...
        <div class="row mt-1">
            <div class="col-md-12">
                <div class="float-left brand-text">
                    <h3>{{trans('file.Import Work Order')}}</h3>
                </div>
            </div>
        </div>
        <br>
            ...
            <div class="col-md-12">
                <div class="card">
                    {{-- <div class="card-header d-flex align-items-center">
                        <h4>{{trans('file.Import Work Order')}}</h4>
                    </div> --}}
                    <div class="card-body">
                        <p class="italic"><small>{{trans('file.The field labels marked with * are required input fields')}}.</small></p>
                        {!! Form::open(['route' => 'work_order.import', 'method' => 'post', 'files' => true, 'class' => 'payment-form']) !!}
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-4">
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <p>{{trans('file.The correct column order is')}} (product_code, quantity, work_order_unit, product_price, discount, tax_name) {{trans('file.and you must follow this')}}. {{trans('file.For Digital product work_order_unit will be n/a')}}. {{trans('file.All columns are required')}}</p>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label></label><br>
                                            <a download href="../public/sample_file/sample_work_order_products.csv" class="btn buttons-print btn-block"><i class="dripicons-download"></i> {{trans('file.Download Sample File')}}</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>{{trans('file.Work Order Status')}} *</label>
...
<script type="text/javascript">
    ...
    $("ul#work_order #work_order-import-menu").addClass("active");
