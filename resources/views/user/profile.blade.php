            ...
            <div class="card ">
                <div class="card-body item-page">
                    <div class="float-left brand-text mt-2 pl-4">
                        <h3>{{trans('file.Update User Profile')}}</h3>
                    </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>{{trans('file.UserName')}}</strong></label><i class="fa fa-asterisk"></i>
                                ...
                                <div class="form-group">
                                    <label>{{trans('file.Email')}}</strong></label><i class="fa fa-asterisk"></i>
                                ...
                                <div class="form-group">
                                    <label>{{trans('file.Phone Number')}}</strong></label><i class="fa fa-asterisk"></i>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>{{trans('file.Current Password')}}</strong></label><i class="fa fa-asterisk"></i>
                                    <input type="password" name="current_pass" required class="form-control" />
                                </div>
                                <div class="form-group">
                                    <label>{{trans('file.New Password')}}</strong></label><i class="fa fa-asterisk"></i>
                                    <input type="password" name="new_pass" required class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>{{trans('file.Confirm Password')}}</strong></label><i class="fa fa-asterisk"></i>
