              ...
              <div class="card-body item-page">
                  ...
                  <div class="float-right mr-2">
                      <div class="form-group">
                          ...
                          <a href="#" data-toggle="modal" data-target="#importWarehouse" class="btn btn-primary"><i class="dripicons-copy mr-1"></i> {{trans('file.import')}}</a>
                          <a href="{{route('warehouse.create')}}" class="btn buttons-add"><i class="fa fa-plus mr-1" aria-hidden="true"></i> {{trans('file.add')}}</a>
                      </div>
                  </div>
              </div>
          </div>
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                <li>
                                    <a class="btn btn-link" href="{{ route('warehouse.edit', $warehouse->id) }}"><i class="dripicons-document-edit"></i> {{trans('file.edit')}}</a></button>
                                </li>
                                <li class="divider"></li>
