            ...
            <div class="card ">
                <div class="card-body item-page">
                    <div class="float-left brand-text mt-2 pl-4">
                        <h3>{{trans('file.Update Product')}}</h3>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <label>{{trans('file.Product Type')}}</strong></label><i class="fa fa-asterisk"></i>
                                        <div class="input-group">
                                          <select name="type" required class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Select Product Type...">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <input type="hidden" name="is_merchandise_hidden" value="{{$lims_product_data->is_merchandise}}">
                                        <label>{{trans('file.Is Merchandise')}}</strong></label><i class="fa fa-asterisk"></i>
                                        <div class="input-group">
                                          <select name="is_merchandise" required class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Select Is Merchandise...">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <input type="hidden" name="is_active_hidden" value="{{$lims_product_data->is_active}}">
                                        <label>{{trans('file.Is Active')}}</strong></label><i class="fa fa-asterisk"></i>
                                        <div class="input-group">
                                          <select name="is_active" required class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Select Is Active...">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>{{trans('file.SKU')}}</strong></label><i class="fa fa-asterisk"></i>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                       ...
                                       <input type="text" name="other_code" class="form-control" value="{{$lims_product_data->other_code}}" >
                                   </div>
                               </div>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group mt-3">
                                        @if($lims_product_data->workorder)
                                            <input type="checkbox" name="workorder" value="1" checked>
                                        @else
...
<script type="text/javascript">
    ...
    $('select[name="is_merchandise"]').val($('input[name="is_merchandise_hidden"]').val());
    variantShowHide();
    diffPriceShowHide();
    if(is_batch)
        $("#variant-option").hide();
