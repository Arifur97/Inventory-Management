            ...
            <div class="card ">
                <div class="card-body item-page">
                    <div class="float-left brand-text mt-2 pl-4">
                        <h3>{{trans('file.Money Transfer')}}</h3>
                    </div>
                    <div class="float-right mr-2">
                        <div class="form-group">
                            ...
                            <button class="btn buttons-add" data-toggle="modal" data-target="#create-money-transfer-modal"><i class="fa fa-plus mr-1" aria-hidden="true"></i> {{trans('file.add')}}</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <table id="money-transfer-table" class="table">
            ...
            <tbody>
                ...
                <tr data-id="{{$money_transfer->id}}">
                    ...
                    <td class="grand-total text-right">{{ number_format((float)$money_transfer->amount, 2, '.', '') }}</td>
                    <td>
                        <div class="btn-group">
                ...
                {!! Form::open(['route' => 'money-transfers.store', 'method' => 'post']) !!}
                  <div class="row">
                      <div class="col-md-6 form-group">
                          <label> {{trans('file.From Account')}}</label><i class="fa fa-asterisk"></i>
                      ...
                      <div class="col-md-6 form-group">
                          <label> {{trans('file.To Account')}}</label><i class="fa fa-asterisk"></i>
