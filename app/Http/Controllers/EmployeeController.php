...
class EmployeeController extends Controller
{
    ...
    public function index()
    {
        ...
        if($role->hasPermissionTo('employees-index')){
            ...
            return view('employee.index', compact('lims_employee_all', 'lims_department_list', 'all_permission', 'lims_designation_list'));
        }
        else
    ...
    public function create()
    {
        ...
        if($role->hasPermissionTo('employees-add')){
            ...
            return view('employee.create', compact('lims_role_list', 'lims_warehouse_list', 'lims_biller_list', 'lims_department_list', 'lims_designation_list'));
        }
        else
            return redirect()->back()->with('not_permitted', 'Sorry! You are not allowed to access this module');
    }
