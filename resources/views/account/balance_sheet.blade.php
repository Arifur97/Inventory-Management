        ...
        <table id="account-table" class="table table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="grand-total text-right">{{number_format((float)$credit[$key], 2, '.', '')}}</td>
                    <td class="grand-total text-right">{{number_format((float)($debit[$key] * -1), 2, '.', '')}}</td>
                    <td class="grand-total text-right">{{number_format((float)($credit[$key] - $debit[$key]), 2, '.', '')}}</td>
                </tr>
                @endforeach
            </tbody>
