                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>{{trans('file.Mail Host')}}</label><i class="fa fa-asterisk"></i>
                                        <input type="text" name="mail_host" class="form-control" value="{{env('MAIL_HOST')}}" required />
                                    </div>
                                    <div class="form-group">
                                        <label>{{trans('file.Mail Address')}}</label><i class="fa fa-asterisk"></i>
                                        <input type="text" name="mail_address" class="form-control" value="{{env('MAIL_FROM_ADDRESS')}}" required />
                                    </div>
                                    <div class="form-group">
                                        <label>{{trans('file.Mail From Name')}}</label><i class="fa fa-asterisk"></i>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>{{trans('file.Mail Port')}}</label><i class="fa fa-asterisk"></i>
                                    ...
                                    <div class="form-group">
                                        <label>{{trans('file.Encryption')}}</label><i class="fa fa-asterisk"></i>
