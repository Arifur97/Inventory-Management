                    ...
                    <div class="card-body">
                        ...
                        {!! Form::open(['route' => 'setting.rewardPointStore', 'files' => true, 'method' => 'post']) !!}
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>{{trans('file.Sold amount per point')}}</label><i class="fa fa-asterisk"></i> <i class="dripicons-question" data-toggle="tooltip" title="{{trans('file.This means how much point customer will get according to sold amount. For example, if you put 100 then for every 100 dollar spent customer will get one point as reward.')}}"></i>
