                ...
                <div class="card-body item-page">
                    ...
                    <div class="float-right mr-2">
                        <div class="form-group">
                            ...
                            <button class="btn buttons-add" data-toggle="modal" data-target="#gift_card-modal"><i class="fa fa-plus mr-1" aria-hidden="true"></i> {{trans('file.add')}}</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              <p class="italic"><small>{{trans('file.The field labels marked with * are required input fields')}}.</small></p>
                ...
                ?>
                  <div class="form-group">
                      <label>{{trans('file.Card No')}}</label><i class="fa fa-asterisk"></i>
