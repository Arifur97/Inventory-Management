            ...
            <div class="card ">
                <div class="card-body item-page">
                    <div class="float-left brand-text mt-2 pl-4">
                        <h3>{{trans('file.Update Purchase Receiving')}}</h3>
                    </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        {!! Form::open(['route' => ['purchase_receiving.update', $lims_purchase_receiving_data->id], 'method' => 'put', 'files' => true, 'id' => 'purchase-form']) !!}
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <p><strong>{{ $lims_purchase_receiving_data->reference_no }}</strong> </p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>{{trans('file.Purchase Reference No')}}</label>
                                            <p><strong>{{ $lims_purchase_receiving_data->purchase_reference_no }}</strong> </p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>{{trans('file.Warehouse')}}</label><i class="fa fa-asterisk"></i>
                                            <input type="hidden" name="warehouse_id_hidden" value="{{$lims_purchase_receiving_data->warehouse_id}}" />
                                            <select required name="warehouse_id" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Select warehouse..." disabled="true">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="supplier_id_hidden" value="{{ $lims_purchase_receiving_data->supplier_id }}" />
                                            <select name="supplier_id" class="selectpicker form-control" data-live-search="true" id="supplier-id" data-live-search-style="begins" title="Select supplier..." disabled="true">
                                                @foreach($lims_supplier_list as $supplier)
                                                <option selected value="{{$supplier->id}}">{{$supplier->name .' ('. $supplier->company_name .')'}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                	<div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="status_hidden" value="{{$lims_purchase_receiving_data->status}}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            // change path on live remove s2
                                                $fullpath = $lims_purchase_receiving_data->documents;
                                                $dividedPath = explode(",", $fullpath);
                                                foreach($dividedPath as $path) {
                                                    $file = str_replace('documents/purchase-receiving/', '', $path);
                                                    echo '<div><div class="col-md-10 float-left"><a class="document-text" href='."http" . (($_SERVER['SERVER_PORT'] == 443) ? "s" : "") . "://" . $_SERVER['HTTP_HOST'] . '/s2/public/documents/purchase-receiving/' . str_replace(' ', '%20', $file) . ' target="_blank">' . $file . '</a></div><div class="col-md-2 float-left"><i class="dripicons-trash" onclick="removeExistingFileName(this);"></i></div></div>';
                                                }
                                            ?>
                                            </div>
                                        ...
                                        <div class="table-responsive mt-3">
                                            <table id="myTable" class="table table-hover order-list">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                    @foreach($lims_product_purchase_receiving_data as $product_purchase)
                                                    <tr>
                                                    <?php
                                                    ...
                                                    ?>
                                                        <td>{{$product_data->name}} <button type="button" class="edit-product btn btn-link" data-toggle="modal" data-target="#editModal"></button></td>
                                                        <td>{{$product_data->code}}</td>
                                                        <td><input type="number" class="form-control qty" name="qty[]" value="{{$product_purchase->qty}}" step="any" required /></td>
                                                        <td class="recieved-product-qty d-none"><input type="number" class="form-control recieved" name="recieved[]" value="{{$product_purchase->received}}" step="any"/></td>
                                                        <td class="discount">{{ $unit->unit_code }}</td>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea rows="5" class="form-control" name="note" >{{ $lims_purchase_receiving_data->note }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
