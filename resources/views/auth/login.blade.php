    ...
    <div class="page login-page">
      <div class="container mt-5">
        <div class="logo-header text-center">
            <p>
                <img class="mr-4" style="width: auto; height: 35px" src="{{asset('/images/LogoHeader.png') }}">
            </p>
        </div>
        <div class="form-outer text-center d-flex align-items-center">
          ...
          <div class="form-inner">
            <div class="logo">
                @if($general_setting->site_logo)
                    <img src="{{url('/logo', $general_setting->site_logo)}}" width="180">
                @else
            ...
            <form method="POST" action="{{ route('login') }}" id="login-form">
                ...
                <button type="submit" class="btn btn-primary-login btn-block">{{trans('file.LogIn')}}</button>
            </form>
            <br><br>
          ...
          <div class="copyrights text-center">
            <a href="http://www.Infinityerp.com/" target="_blank">
                <p>
                    <img class="mr-2" style="width: 20%" src="{{asset('/images/LogoFooter.png') }}">
                    <span class="external"> Developed By Infinity IT Services</span>
                </p>
            </a>
          </div>
        </div>
