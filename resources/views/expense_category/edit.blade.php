...
<section class="forms">
    <!--- header section  --->
    {!! Form::open(['route' => ['expense_categories.update', $lims_expense_categories_all->id ], 'method' => 'put', 'files' => true]) !!}
    <div class="row ">
        <div class="col-md-12 item-sticky">
            <div class="card ">
                <div class="card-body item-page">
                    <div class="float-left brand-text mt-2 pl-4">
                        <h3>{{trans('file.Update Expense Category')}}</h3>
                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="code" required class="form-control" value="{{$lims_expense_categories_all->code}}" />
                                            <input type="hidden" name="expense_category_id" value="{{$lims_expense_categories_all->id}}" />
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>{{trans('file.name')}}</label><i class="fa fa-asterisk"></i>
                                            <input type="text" name="name" required class="form-control" value="{{$lims_expense_categories_all->name}}" />
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="account_id_hidden" value="{{$lims_expense_categories_all->account_id}}" />
