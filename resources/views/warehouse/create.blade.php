            ...
            <div class="card ">
                <div class="card-body item-page">
                    <div class="float-left brand-text mt-2 pl-4">
                        <h3>{{trans('file.Add Warehouse')}}</h3>
                    </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        {!! Form::open(['route' => 'warehouse.store', 'method' => 'post', 'files' => true]) !!}
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" placeholder="Location Name..." name="name" required class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
