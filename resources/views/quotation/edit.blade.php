            ...
            <div class="card ">
                <div class="card-body item-page">
                    <div class="float-left brand-text mt-2 pl-4">
                        <h3>{{trans('file.Update Quotation')}}</h3>
                    </div>
                    <div class="float-right mr-2">
                        <div class="form-group">
                            <a href="{{route('quotations.index')}}" class="btn buttons-add"><i class="fa fa-times mr-1"></i> {{trans('file.Cancel')}}</a>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="table-responsive mt-3">
                                            <table id="myTable" class="table table-hover order-list">
                                                <thead>
                                                    <tr>
                                                        <th style="border-radius: 5px 0px 0px 5px">{{trans('file.name')}}</th>
                                                        ...
                                                        <th style="border-radius: 0px 5px 5px 0px"><i class="dripicons-trash"></i></th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <?php
                                                ...
                                                <tfoot class="tfoot active">
                                                    <th colspan="2" style="border-radius: 5px 0px 0px 5px" >{{trans('file.Total')}}</th>
                                                    <th></th>
