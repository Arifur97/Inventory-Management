                ...
                <div class="card-body item-page">
                    ...
                    <div class="float-right mr-2">
                        <div class="form-group">
                            ...
                            <a href="#" data-toggle="modal" data-target="#importTax" class="btn btn-primary"><i class="dripicons-copy mr-1"></i> {{trans('file.import')}}</a>
        ...
        <div class="row mt-1">
            <div class="col-md-12">
                ...
                <div class="float-right">
                    <a href="#" data-toggle="modal" data-target="#importTax" class="btn btn-primary"><i class="dripicons-copy"></i> {{trans('file.import')}}</a>
                    <a href="#" class="btn buttons-add" data-toggle="modal" data-target="#createModal"><i class="fa fa-plus mr-1" aria-hidden="true"></i> {{trans('file.add')}}</a>
                </div>
            </div>
        </div>
    ...
    <div role="document" class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form>
                    <div class="form-group">
                    <label>{{trans('file.Tax Name')}}</label><i class="fa fa-asterisk"></i>
                    {{Form::text('name',null,array('required' => 'required', 'class' => 'form-control'))}}
                    </div>
                    <div class="form-group">
                        <label>{{trans('file.Rate')}}(%)</label><i class="fa fa-asterisk"></i>
