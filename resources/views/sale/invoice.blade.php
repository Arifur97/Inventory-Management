    ...
    <div id="receipt-data">
        <div class="centered">
            @if($general_setting->site_logo)
                <img src="{{url('public/logo', $general_setting->site_logo)}}" height="48" width="140" style="margin:10px 0;filter: brightness(0);">
            @endif
        ...
        <table class="table-data">
            ...
            <!-- <tfoot> -->
                ...
                <tr>
                    ...
                    <td style="text-align:right; font-weight:bold;">{{number_format((float)($total_product_tax / 2), 2, '.', '')}}</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <th class="invoice-value" style="text-align:right">{{number_format((float)$lims_sale_data->grand_total, 2, '.', '')}}</th>
                </tr>
                <tr>
        ...
        <table>
            <tbody>
                ...
                <tr style="background-color:#ddd;">
                    <td style="padding: 5px;width:30%;  font-weight:bold;">{{trans('file.Paid By')}}: {{$payment_data->paying_method}}</td>
                    <td style="padding: 5px;width:40%;  font-weight:bold;">{{trans('file.Amount')}}: {{number_format((float)$payment_data->amount, 2, '.', '')}}</td>
                    <td style="padding: 5px;width:30%;  font-weight:bold;">{{trans('file.Change')}}: {{number_format((float)$payment_data->change, 2, '.', '')}}</td>
                </tr>                
                @endforeach
