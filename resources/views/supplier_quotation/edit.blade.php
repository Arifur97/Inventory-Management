            ...
            <div class="card ">
                <div class="card-body item-page">
                    <div class="float-left brand-text mt-2 pl-4">
                        <h3>{{trans('file.Update Supplier Quotation')}}</h3>
                    </div>
                    <div class="float-right mr-2">
                        <div class="form-group">
                            <a href="{{route('quotation_supplier.index')}}" class="btn buttons-add"><i class="fa fa-times mr-1"></i> {{trans('file.Cancel')}}</a>
                                            ...
                                            <table id="myTable" class="table table-hover order-list">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        ...
                                                        <td class="net_unit_cost text-right">{{ number_format((float)$product_purchase->net_unit_cost, 2, '.', '') }} </td>
                                                        <td class="discount text-right">{{ number_format((float)$product_purchase->discount, 2, '.', '') }}</td>
                                                        <td class="tax text-right">{{ number_format((float)$product_purchase->tax, 2, '.', '') }}</td>
                                                        <td class="sub-total text-right">{{ number_format((float)$product_purchase->total, 2, '.', '') }}</td>


                                                        <td class="p-note"><textarea type="text" class="form-control" rows="3" cols="30" name="pnote[]">{{$product_purchase->pnote }}</textarea></td></td>
                                                ...
                                                <tfoot class="tfoot active">
                                                    ...
                                                    <th id="total-discount" class="text-right">{{ number_format((float)$lims_purchase_data->total_discount, 2, '.', '') }}</th>
                                                    <th id="total-tax" class="text-right">{{ number_format((float)$lims_purchase_data->total_tax, 2, '.', '')}}</th>
                                                    <th id="total" class="text-right">{{ number_format((float)$lims_purchase_data->total_cost, 2, '.', '') }}</th>
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            if(flag){
                ...
                cols += '<td><textarea type="text" class="form-control" rows="3" cols="30" name="pnote[]"></textarea></td></td>';
