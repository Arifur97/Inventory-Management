...
<section class="forms">
    <div class="container-fluid">
        <div class="row mt-1">
            <div class="col-md-12">
                <div class="float-left brand-text">
        ...
        <table id="account-table" class="table table-hover">
            <thead>
                <tr>
                    ...
                    <th class="text-right">{{trans('file.Credit')}}</th>
                    <th class="text-right">{{trans('file.Debit')}}</th>
                    <th class="text-right" style="border-radius: 0px 5px 5px 0px">{{trans('file.Balance')}}</th>
                </tr>
            </thead>
            <tbody>
                ...
                <tr>
                    ...
                    @else
                        <td></td>
                    @endif
                    <td class="grand-total text-right">{{number_format((float)$credit->amount, 2, '.', '')}}</td>
                    <td class="grand-total text-right">0.00</td>
                    <td class="grand-total text-right">{{number_format((float)$balance, 2, '.', '')}}</td>
                </tr>
                @endforeach
                ...
                <tr>
                    ...
                    <td></td>
                    <td class="grand-total text-right">{{number_format((float)$recieved_money->amount, 2, '.', '')}}</td>
                    <td class="grand-total text-right">0.00</td>
                    <td class="grand-total text-right">{{number_format((float)$balance, 2, '.', '')}}</td>
                </tr>
                @endforeach
                ...
                <tr>
                    ...
                    @endif
                    <td class="grand-total text-right">0.00</td>
                    <td class="grand-total text-right">{{number_format((float)$debit->amount, 2, '.', '')}}</td>
                    <td class="grand-total text-right">{{number_format((float)$balance, 2, '.', '')}}</td>
                </tr>
                @endforeach
                ...
                <tr>
                    ...
                    @endif
                    <td class="grand-total text-right">0.00</td>
                    <td class="grand-total text-right">{{number_format((float)$return->grand_total, 2, '.', '')}}</td>
                    <td class="grand-total text-right">{{number_format((float)$balance, 2, '.', '')}}</td>
                </tr>
                @endforeach
                ...
                <tr>
                    ...
                    <td></td>
                    <td class="grand-total text-right">0.00</td>
                    <td class="grand-total text-right">{{number_format((float)$payroll->amount, 2, '.', '')}}</td>
                    <td class="grand-total text-right">{{number_format((float)$balance, 2, '.', '')}}</td>
                </tr>
                @endforeach
                ...
                <tr>
                    ...
                    <td></td>
                    <td class="grand-total text-right">0.00</td>
                    <td class="grand-total text-right">{{number_format((float)$sent_money->amount, 2, '.', '')}}</td>
                    <td class="grand-total text-right">{{number_format((float)$balance, 2, '.', '')}}</td>
                </tr>
                @endforeach
            </tbody>
