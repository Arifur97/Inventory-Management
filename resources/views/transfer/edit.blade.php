...
<div id="alert"></div>
    <section class="forms">
                ...
                <div class="card ">
                    <div class="card-body item-page">
                        <div class="float-left brand-text mt-2 pl-4">
                            <h3>{{trans('file.Update Transfer')}}</h3>
                        </div>
                                            ...
                                            <div class="table-responsive mt-3">
                                                <table id="myTable" class="table table-hover order-list">
                                                            ...
                                                            <tr>
                                                                ...
                                                                if ($product_transfer->variant_id) {
                                                                    $product_variant_data = \App\ProductVariant::select('id', 'item_code')
                                                                        ->FindExactProduct($product_data->id, $product_transfer->variant_id)
                                                                        ->first();
                                                                ...
                                                                $tax = DB::table('taxes')
                                                                    ->where('rate', $product_transfer->tax_rate)
                                                                    ->first();
                                                                ...
                                                                ?>
                                                                <td>
                                                                    <img src="{{url('/images/product', $product_data->image)}}" class="product_image" width="80" height="80"/> </td>
                                                                </td>
                                                                ...
                                                                <td>
                                                                    <input type="number" class="form-control qty" name="qty[]" value="{{ $product_transfer->qty }}" readonly required step="any" />
                                                                </td>
                                                                <td class="net_unit_cost">
                                                                    {{ number_format((float) $product_transfer->net_unit_cost, 2, '.', '') }}
                                                                </td>
                                                                <td class="tax">
                                                                    {{ number_format((float) $product_transfer->tax, 2, '.', '') }}
                                                                </td>
                                                                <td class="sub-total">
                                                    ...
                                                    <tfoot class="tfoot active">
                                                        ...
                                                        <th></th>
                                                        <th id="total-tax">
                                                            {{ number_format((float) $lims_transfer_data->total_tax, 2, '.', '') }}
                                                        </th>
                                                        <th id="total">
                                                            {{ number_format((float) $lims_transfer_data->total_cost, 2, '.', '') }}
                                                        </th>
                                                        <th><i class="dripicons-trash"></i></th>
                                                    </tfoot>
                                                </table>
        ...
        @include(
            ...
            [
                'route' => route('transfers.multifile.update'),
                'edit' => true,
                'documents' => $lims_transfer_data->documents,
            ]
        )
    </section>
    <script type="text/javascript">
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (flag) {
                        ...
                        cols += '<td>' + data[1] + '</td>';
                        cols +=
                            '<td><input type="number" class="form-control qty" readonly name="qty[]" value="1" required step="any"/></td>';
        ...
        function calculateRowProductData(quantity) {
            ...
            if (tax_method[rowindex] == 1) {
                ...
                $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('td:nth-child(4)').text(net_unit_cost
                    .toFixed(2));
                $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('.net_unit_cost').val(net_unit_cost
                    .toFixed(2));
                $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('td:nth-child(5)').text(tax.toFixed(
                    2));
                $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('.tax-value').val(tax.toFixed(2));
                $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('td:nth-child(6)').text(sub_total
                    .toFixed(2));
