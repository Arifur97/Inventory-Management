                ...
                <div class="card ">
                    <div class="card-body item-page">
                        <div class="float-left brand-text mt-2 pl-4">
                            <h3>{{ trans('file.Update Sale') }}</h3>
                        </div>
                        <div class="float-right mr-2">
                            <div class="form-group">
                                <a href="{{ route('sales.index') }}" class="btn buttons-add"><i class="fa fa-times mr-1"></i> {{ trans('file.Cancel') }}</a>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select required id="warehouse_id" name="warehouse_id" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Select warehouse...">
                                                        @foreach ($lims_warehouse_list as $warehouse)
                                                            <option value="{{ $warehouse->id }}" @if(Auth::user()->default_warehouse_id == $warehouse->id) selected @endif>{{ $warehouse->name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-md-12">
                                                ...
                                                <div class="search-box input-group">
                                                    ...
                                                    <button type="button" class="btn btn-secondary" data-toggle="modal" data-target="#bulkProduct" onclick="setDataOnBulkProduct()" title="{{ trans('file.Add multiple products from list') }}">
                                                    ...
                                                    <table id="myTable" class="table table-hover order-list">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th class="text-right">{{ trans('file.Net Unit Price') }}</th>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            @foreach ($lims_product_sale_data as $product_sale)
                                                                <input type="hidden" name="sale_product_id_hidden[]"
                                                                    class="sale_product_id_hidden"
                                                                    value="{{ $product_sale->product_id }}">
                                                                <tr>
                                                                    <?php
                                                                    ...
                                                                    ?>
                                                                    <td><img src="{{ asset("/public/images/product/$product_data->image") }}"
                                                                            alt="product image" class="product_image"
                                                                            width="80" height="80" /></td>
                                                                    <td>{{ $product_data->name }} <input type="hidden"
                                                                            class="product-type"
                                                                    ...
                                                                    <td class="net_unit_price text-right">
                                                                        <input type="text" class="form-control text-right" value="{{ number_format((float) $product_sale->net_unit_price, 2, '.', '') }}">
                                                                    </td>
                                                                    <td class="discount text-right">
                                                                        <input type="text" class="form-control text-right" value="{{ number_format((float) $product_sale->discount, 2, '.', '') }}">
                                                                    ...
                                                                    <td>
                                                                        <button type="button" class="d-none edit-product btn btn-primary" data-toggle="modal" data-target="#editModal"><i class="dripicons-document-edit"></i></button>
                                                                        <button type="button" onclick="removeDataFromTable({{ $product_data->id }})" class="ibtnDel btn btn-md btn-danger"><i class="dripicons-trash"></i></button>
                                                                    </td>
                                                        ...
                                                        <tfoot class="tfoot active">
                                                            ...
                                                            <th></th>
                                                            <th></th>
                                                            <th class="text-right" id="total-discount">
                                                                {{ number_format((float) $lims_sale_data->total_discount, 2, '.', '') }}
                                                            </th>
                                                            <th class="text-right" id="total-tax">
                                                                {{ number_format((float) $lims_sale_data->total_tax, 2, '.', '') }}
                                                            </th>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label>{{ trans('file.Sale Status') }}</label><i class="fa fa-asterisk"></i>
                                                    <input type="hidden" name="sale_status_hidden" value="{{ $lims_sale_data->sale_status }}" />
                                                    <select name="sale_status" class="form-control">
                                                        <option value="1">{{ trans('file.Draft') }}</option>
                                            ...
                                            @if ($lims_sale_data->coupon_id)
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <p class="mt-2 pl-2"><strong id="coupon-text">{{ number_format((float) $lims_sale_data->coupon_discount, 2, '.', '') }}</strong>
                                                        </p>
                                                    </div>
                                                </div>
                                            @endif
                                    ...
                                    <tbody>
                                        @foreach ($lims_product_list as $key => $product)
                                            <tr>
                                                <td>{{ $key }}</td>
                                                <td>
                                                    <img src="{{ asset('/public/images/product/' . $product->image) }}" alt="product image" class="product_image" width="80" height="80" />
                                                </td>
                                                <td>{{ $product->name }}</td>
...
function setDataOnBulkProduct() {
    const data = document.getElementsByClassName('sale_product_id_hidden');
...
function AddProductsToTable(products) {
    products.forEach(data => {
        product_warehouse_price = data[7];
        if (hasDataOnTable(data[9])) {
            let imgSrc = window.location.protocol + '//' + window.location.hostname + ':' + window.location
                .port + '/images/product/' + data[22];
            let newRow = $("<tr>");
            let cols = '';
            ...
            if (data[12]) {
                cols += '<td><input type="text" class="form-control batch-no" value="' + batch_no[pos] +
            ...
            cols += '<td><input class="net_unit_price form-control text-right" /></td>';
            // cols += '<td class="discount text-right">0.00</td>';
            cols += '<td><input class="discount text-right form-control" value="0.00" /></td>';
            cols += '<td class="tax text-right"></td>';
            cols += '<td class="sub-total text-right"></td>';
            cols +=
                '<td><button type="button" class="d-none edit-product btn btn-primary" data-toggle="modal" data-target="#editModal"><i class="dripicons-document-edit"></i></button> <button type="button" onclick="removeDataFromTable(' +
                data[9] +
                ')" class="ibtnDel btn btn-md btn-danger"><i class="dripicons-trash"></i></button></td>';
            cols += '<input type="hidden" class="product-code" name="product_code[]" value="' + data[1] +
                '"/>';
            cols += '<input type="hidden" class="product-id" name="product_id[]" value="' + data[9] + '"/>';
            cols += '<input type="hidden" class="sale-unit" name="sale_unit[]" value="' + temp_unit_name[
                0] + '"/>';
            ...
            if (!data[11] && product_warehouse_price[pos]) {
                ...
                product_price.splice(rowindex, 0, parseFloat(data[2] * currency['exchange_rate']) +
                    parseFloat(data[2] * currency['exchange_rate'] * (customer_group_rate || 1)));
            }
        ...
        success: function(data) {
            ...
            if (flag) {
                ...
                cols += '<td> <img src="' + window.location.protocol + '//' + window.location.hostname +
                    '/' + window.location.port + 's2/public/images/product/' + data[22] +
                ...
                cols += '<td class="sub-total text-right"></td>';
                cols +=
                    '<td><button type="button" class="d-none edit-product btn btn-primary" data-toggle="modal" data-target="#editModal"><i class="dripicons-document-edit"></i></button> <button type="button" class="ibtnDel btn btn-md btn-danger"><i class="dripicons-trash"></i></button></td>';
