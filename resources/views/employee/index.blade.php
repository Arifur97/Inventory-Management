                ...
                <div class="card-body item-page">
                    ...
                    <div class="float-right mr-2">
                        <div class="form-group">
                            ...
                            <a href="{{route('employees.create')}}" class="btn buttons-add"><i class="fa fa-plus mr-1"></i> {{trans('file.add')}}</a>
                            @endif
                    </div>
                </div>
            </div>
    ...
    <div class="table-responsive">
        <table id="employee-table" class="table">
            ...
            <tbody>
                ...
                @php $designation = \App\Designation::find($employee->designation_id); @endphp
                <tr data-id="{{$employee->id}}">
                    <td>{{$key}}</td>
                    @if($employee->image)
                    <td class="employee-image"> <img src="{{url('public/images/employee',$employee->image)}}" height="80" width="80">
                    </td>
                    @else
                    <td class="employee-image">No Image</td>
                    @endif
                    <td>{{ $employee->name }}</td>
...
<script type="text/javascript">
    ...
    $(document).on('click', '.edit-btn', function() {
        ...
        $("#editModal select[name='designation_id']").val( $(this).data('designation_id') );
