...
class AccountsController extends Controller
{
    public function index()
    {
        ...
        if($role->hasPermissionTo('account-index')){
            ...
            $lims_account_all = Account::with('account_category', 'company', 'currency')->orderBy('id', 'desc')->where('is_active', true)->get();
    ...
    {
        $lims_account_all = Account::where('is_active', true)->get();
        $lims_account_category_all = AccountCategories::where('is_active', true)->get();
        $lims_currency_all = Currency::all();
        $lims_company_all = Company::where('is_active', true)->get();
        return view('account.create', compact('lims_account_all', 'lims_company_all', 'lims_account_category_all', 'lims_currency_all'));
    }
    ...
    public function edit($id)
    {
        ...
        $lims_currency_all = Currency::all();
        $lims_company_all = Company::where('is_active', true)->get();
        $lims_account_all = Account::find($id);
        return view('account.edit', compact('lims_account_all', 'lims_account_category_all', 'lims_currency_all', 'lims_company_all'));
    }
