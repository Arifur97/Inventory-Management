            ...
            <div class="card ">
                <div class="card-body item-page">
                    <div class="float-left brand-text mt-2 pl-4">
                        <h3>{{trans('file.Supplier Report')}}</h3>
                    </div>
        ...
        <div role="tabpanel" class="tab-pane fade show active" id="supplier-purchase">
            <div class="table-responsive mb-4">
                <table id="purchase-table" class="table table-hover">
                    <thead>
                        <tr>
                            <th class="not-exported-purchase" style="border-radius: 5px 0px 0px 5px"></th>
                            ...
                            <th style="border-radius: 0px 5px 5px 0px">{{trans('file.Status')}}</th>
                        </tr>
                    </thead>
                    <tbody>
